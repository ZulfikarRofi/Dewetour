...
export default function PaymentPage() {
  return (
    ...
    <div className="plain-backdrop">
                            ...
                            <Row>
                                <Col md={6}>
                                    <div className="transaction-dest d-flex flex-column justify-content-between ps-5">
                                        ...
                                        <h6 className="alert alert-danger status-transaction py-1 px-0">
                                            Waiting Payment
                                        </h6>
                                    </div>
                                </Col>
        ...
        <div className="pay-loc d-flex justify-content-end mt-4">
            <Button className="button-first">PAY</Button>
        </div>
        </Container>
    </div>
    </>
